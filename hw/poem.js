...
// 4. Извлечение подстроки (с 28 по 50 символ)
const newText = result.slice(28, 50);

// 5. Замена "клён" на "дубе" в newText
...
// 7. Замена всех вхождений "клён" на "дуб" в result
const replacedText3 = result.replace(/клён/g, 'дуб');

// 8. Поиск индекса первого вхождения "моря"
...
// Вывод результатов
console.log(`1. Количество символов в тексте: ${length}`);
